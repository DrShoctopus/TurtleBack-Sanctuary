...
export const BENCHMARKS = {
  ...
  'village-threshold': { mode: 'teleport', x: -6, z: -74, yaw: -2.967, pitch: -0.055 },
  'market-lane': { mode: 'teleport', x: 31, z: -40, yaw: 2.897, pitch: -0.055 },
  'garden-workyard': { mode: 'teleport', x: -77, z: 88, yaw: -2.316, pitch: -0.07 },
  ...
  'blossomshade-grove': { mode: 'teleport', x: 62, z: 77, yaw: -2.285, pitch: -0.08 },
  'lumenfen-pools': { mode: 'teleport', x: -35, z: 60, yaw: 2.546, pitch: -0.1 },
  'fernfall-ravine': { mode: 'teleport', x: -72, z: 105, yaw: 2.256, pitch: -0.1 },
  'galecrest-scrub': { mode: 'teleport', x: 55, z: -172, yaw: -0.804, pitch: -0.08 },
  'hearth-commons': { mode: 'teleport', x: 28, z: -70, yaw: 2.504, pitch: -0.06 },
  'blossom-grazer-close': { mode: 'fixed', position: [78, 16.5, 90], lookAt: [90, 15, 100] },
  'lumenfen-heron-close': { mode: 'fixed', position: [-48, 16.5, 85], lookAt: [-62, 15, 92] },
  'fernfall-details': { mode: 'fixed', position: [-87, 15.5, 119], lookAt: [-104, 12.5, 132] },
  'galecrest-details': { mode: 'fixed', position: [75, 13.5, -188], lookAt: [92, 10, -204] },
  'hearth-details': { mode: 'fixed', position: [32, 18.5, -60], lookAt: [20, 16, -49] },
