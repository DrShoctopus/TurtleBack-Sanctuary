...
- 2026-07-12 — Comfort, interaction, and landmark motion pass: an accumulated comfort clock slows turtle, vegetation, clouds, aurora, ocean laps, gulls, and voyage-landmark animation without phase jumps. Blinds ease between positions; brewing produces steam; watering and chimes receive visible bursts; the television reacts when active; landmark detail now removes decorative meshes by quality rather than changing scale.
- 2026-07-12 — Interior/environment correction pass I: open shelf carcasses reveal books and goods, kitchenette appliances remain inside their authored runs, home blinds match real window openings, the television gains a frame and stand, pavilion lighting gains a cord, bath towels clear their locker, street lamps avoid building pads, the observatory dome clears head height, monolith edge lights follow their rotated towers, roof/ceiling separation is increased, and the café roof forms a true butterfly valley.
- 2026-07-12 — Interior/environment correction pass II: the 24-view benchmark sweep confirmed stable world-scale texture alignment and repaired the remaining coplanar home rug, unsupported bedside shade, and unsupported home/bathhouse towel stacks. The pond bridge now uses a smooth pitched collision ribbon beneath its level boards, removing capsule snags along the arch.
